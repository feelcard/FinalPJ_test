		...
		<div class="content-wrapper">
			<div class="content-header row">
				<div class="content-header-left col-md-6 col-xs-12 mb-1">
					...
					<form class="form" action="hadoopChartdata" method="POST">
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<input type="text" id="projectinput0" class="form-control"
										placeholder="AD name" name="adname"
									...
									<input type="date" id="projectinput2" class="form-control"
										name="enddate"
										style=" width: 120px; height: 30px; font-size: 10px;">
									<input type="submit" class="btn btn-primary btn-min-width mr-1 mb-1"
										value="submit">
			...
			<div class="content-body" id="chartBody">
...
<!-- BEGIN PAGE LEVEL JS-->
<script
	src="./resources/app-assets/js/scripts/charts/chartjs/hadoopchart/selectChart.js"
