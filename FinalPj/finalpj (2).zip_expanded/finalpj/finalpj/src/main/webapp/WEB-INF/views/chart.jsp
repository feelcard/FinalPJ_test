			...
			<div class="content-header row">
				<div class="content-header-left col-md-6 col-xs-12 mb-1">
					<h2 class="content-header-title">Chartjs Line Chart</h2>
						...
						onclick="getChart()">primary</button>-->
				</div>
				<div
...
<!-- BEGIN PAGE LEVEL JS-->
<script
	src="./resources/app-assets/js/scripts/charts/chartjs/line/line.js"
	type="text/javascript"></script>
<script
	src="./resources/app-assets/js/scripts/charts/chartjs/bar/bar.js"
	type="text/javascript"></script>
<script
	src="./resources/app-assets/js/scripts/charts/chartjs/pie-doughnut/pie-simple.js"
	type="text/javascript"></script>
<script
	src="./resources/app-assets/js/scripts/charts/chartjs/pie-doughnut/doughnut-simple.js"
	type="text/javascript"></script>
<!-- END PAGE LEVEL JS-->