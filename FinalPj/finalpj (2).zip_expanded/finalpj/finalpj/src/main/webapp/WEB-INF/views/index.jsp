      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav">
            ...
            <li class="nav-item"><a href="index.html" class="navbar-brand nav-link"><img alt="branding logo" src="./resources/app-assets/images/logo/robust-logo-light.png" data-expand="./resources/app-assets/images/logo/robust-logo-light.png" data-collapse="./resources/app-assets/images/logo/robust-logo-small.png" class="brand-logo"></a></li>
        ...
        <div class="navbar-container content container-fluid">
          <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
            ...
            <ul class="nav navbar-nav float-xs-right">
              ...
              <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="./resources/app-assets/images/portrait/small/avatar-s-1.png" alt="avatar"><i></i></span><span class="user-name">John Doe</span></a>
        ...
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          ...
          <li class=" nav-item"><a href="chart"><i class="icon-stats-dots"></i><span data-i18n="nav.chartjs.main" class="menu-title">Chart</span></a>
           <ul class="menu-content">
              <li><a href="hadoopChart" data-i18n="nav.chartjs.chartjs_line_charts" class="menu-item">Line charts</a>
              </li>
